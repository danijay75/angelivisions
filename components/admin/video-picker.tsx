...
import { Video, Upload, LinkIcon, Trash2, Loader2, Play } from "lucide-react"
...
export default function VideoPicker({ label = "Vidéo", value, onChange, hint }: VideoPickerProps) {
            ...
            <div className="flex-1 space-y-3">
              <div className="flex flex-wrap gap-2">
                ...
                >
                  ...
                  {isUploading ? "Upload en cours..." : "Importer .mp4 / .mov"}
                </Button>
                <input
                  ref={fileRef}
                  type="file"
              ...
              {!value && <p className="text-white/40 text-[10px] uppercase tracking-wider font-medium">Formats: MP4, MOV (MAX: 100 MO)</p>}
            </div>
          </div>
        </CardContent>
      </Card>
