    ...
    <section className="py-20 bg-slate-900/30">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 via-cyan-500 to-blue-500 transform md:-translate-x-0.5"></div>
          ...
          {timelineSteps.map((step, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-8 md:left-1/2 w-4 h-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full transform md:-translate-x-2 z-10"></div>
              ...
              >
                <ArrowRight className={`w-6 h-6 text-cyan-400 ${index % 2 === 0 ? "" : "rotate-180"}`} />
              </div>
            </motion.div>
          ))}
        </div>
