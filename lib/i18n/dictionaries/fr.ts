const fr = {
  ...
  services: {
    ...
    clientTypes: {
      ...
      mariages: { title: "Mariages", desc: "Cérémonies et réceptions sur-mesure" },
  ...
  devis: {
    ...
    description: "Dites-nous en plus sur votre projet. Nous vous répondons sous 24h avec une proposition sur-mesure.",
    ...
    guarantee: "Réponse garantie sous 24h • Devis gratuit et sans engagement",
    success: {
      title: "Demande envoyée !",
      message: "Merci pour votre demande de devis. Notre équipe vous contactera dans les 24h pour discuter de votre projet et vous proposer une solution sur-mesure.",
  ...
  footer: {
    ...
    services: {
      ...
      technical: "Prestations Techniques",
      ledWalls: "Murs de LED",
      media: "Captations et prises de vue",
    },
  },
  blog: {
    title: "eSide Culture",
  ...
  devis: {
    ...
    highlight: "Devis Express",
    description: "Décrivez votre projet et recevez une estimation personnalisée sous 48 heures.",
    formTitle: "Votre projet en détails",
    eventType: "Type d'événement",
    eventTypes: {
      wedding: "Mariage",
    ...
    servicesTitle: "Services souhaités",
    services: {
      dj: "DJ / Animation musicale",
      production: "Production musicale",
      organization: "Organisation événementielle",
      technical: "Prestation technique",
      ledWalls: "Murs LED",
      mapping: "Mapping vidéo",
      media: "Captation photo / vidéo",
    },
    date: "Date de l'événement",
    guests: "Nombre d'invités",
    location: "Lieu",
    budget: "Budget estimé",
    budgetDiscuss: "À définir ensemble",
    name: "Nom complet",
    email: "Email",
    phone: "Téléphone",
    company: "Entreprise (facultatif)",
    projectDescription: "Description du projet",
    placeholder: "Décrivez votre projet, vos envies, le style souhaité…",
    submit: "Envoyer ma demande",
    sending: "Envoi en cours…",
    error: "Une erreur est survenue lors de l'envoi.",
    guarantee: "Réponse garantie sous 48h — Sans engagement",
    success: {
      title: "Demande envoyée avec succès !",
      message: "Nous reviendrons vers vous dans les 48 heures avec une proposition personnalisée.",
      newRequest: "Nouvelle demande",
    },
  },
}
