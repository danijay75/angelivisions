const es = {
  ...
  devis: {
    title: "Solicite su",
    highlight: "Presupuesto Exprés",
    description: "Describa su proyecto y reciba un presupuesto personalizado en 48 horas.",
    formTitle: "Los detalles de su proyecto",
    eventType: "Tipo de evento",
    eventTypes: {
      wedding: "Boda",
    ...
    servicesTitle: "Servicios deseados",
    services: {
      dj: "DJ / Animación musical",
      production: "Producción musical",
      organization: "Organización de eventos",
      technical: "Servicios técnicos",
      ledWalls: "Pantallas LED",
      mapping: "Video mapping",
      media: "Captura foto / vídeo",
    },
    date: "Fecha del evento",
    guests: "Número de invitados",
    location: "Lugar",
    budget: "Presupuesto estimado",
    budgetDiscuss: "A discutir juntos",
    name: "Nombre completo",
    email: "Correo electrónico",
    phone: "Teléfono",
    company: "Empresa (opcional)",
    projectDescription: "Descripción del proyecto",
    placeholder: "Describa su proyecto, sus deseos, el estilo deseado…",
    submit: "Enviar mi solicitud",
    sending: "Enviando…",
    error: "Se produjo un error al enviar.",
    guarantee: "Respuesta garantizada en 48h — Sin compromiso",
    success: {
      title: "¡Solicitud enviada con éxito!",
      message: "Nos pondremos en contacto con usted en 48 horas con una propuesta personalizada.",
      newRequest: "Nueva solicitud",
    },
  },
}
